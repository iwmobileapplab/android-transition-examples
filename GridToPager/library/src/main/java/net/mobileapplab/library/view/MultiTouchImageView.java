...
public class MultiTouchImageView extends AppCompatImageView implements SwipeToDismissTouchListener.SwipeableViewProvider {
    ...
    public boolean isCompleteInitialPreDraw;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (isInitializationComplete() && isCompleteInitialPreDraw) {
            initializeViewRect();
